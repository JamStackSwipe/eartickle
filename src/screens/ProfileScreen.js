...
import SpendTickles from '../components/SpendTickles';
...
const ProfileScreen = () => {
  ...
  return (
    <div className="p-4 max-w-xl mx-auto space-y-10">
      ...
      {/* Bio */}
      <div className="text-center text-gray-600 max-w-md mx-auto text-sm">
        {editing === 'bio' ? (
          <div className="flex flex-col items-center">
            <textarea
              value={profile.bio || ''}
      ...
      {songs.length > 0 && (
        <div className="space-y-8">
          <h3 className="text-xl font-semibold text-white border-b border-zinc-700 pb-1">📤 My Uploads</h3>
          {songs.map((song) => (
            <div key={song.id}>
              <MySongCard
                song={song}
      ...
      {jamStackSongs.length > 0 && (
        <div className="space-y-8 pt-8 border-t border-zinc-800">
          <h3 className="text-xl font-semibold text-white border-b border-zinc-700 pb-1">🎵 My Jam Stack</h3>
